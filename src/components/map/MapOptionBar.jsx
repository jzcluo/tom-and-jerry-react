    ...
    render() {
        ...
        switch (this.props.displayOption) {
            case 'SEARCHBYDATE':
                sidebar =   <div>
                                <p>Start date:</p>
                                <DatePicker className="sidebar-datepicker" selected={this.state.startDate} onChange={this.handleDateChange.bind(null, "startDate")}/>
                                <p>End date:</p>
                                <DatePicker className="sidebar-datepicker" selected={this.state.endDate} onChange={this.handleDateChange.bind(null, "endDate")}/>
